...
export default function SendButton({ user, ...props }: ComponentProps<'button'> & { user: User }) {
  ...
  return (
    <button
      ...
      {...props}
      className={clsx(
        'hopper h-10 rounded-md bg-zinc-900 px-6 text-zinc-200 duration-100 hover:bg-zinc-800 disabled:opacity-50',
        props.className,
      )}
    >
